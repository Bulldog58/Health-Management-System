"""
Django settings for hrms_settings project.
...
# DEBUG should be True locally, but False on Render
...
ROOT_URLCONF = 'hrms_settings.urls'
...
WSGI_APPLICATION = 'hrms_settings.wsgi.application'
...
if not DEBUG:
    ...
    # Required when running behind a proxy like Render
